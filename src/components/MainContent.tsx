...
export default function MainContent(): JSX.Element {
  ...
  const [view, setView] = useState<"home" | "form" | "study-list" | "resource" | "random">("home");
  ...
  return (
    ...
    <div className="tags">
      ...
      <div className="upload">
        ...
        <button onClick={handleUploadClick} className="upload--button">+</button>
      </div>
      }
      <RecentResources/>
      <UserRecommendations/>
   ...
   <section className="study-list">
    ...
    <h1>My Study List</h1>
    <p>Add resources to your list and work through them at your own pace.</p>
    <MyStudyList/>
   </section>
   }
    </>
